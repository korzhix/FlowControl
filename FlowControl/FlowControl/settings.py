"""
Django settings for FlowControl project.
...
SECRET_KEY = 'i=fmmp%*=(ciw@quk!1$j8w7!6bi^0p8gqezu(ws*ua#mg3mgt'
...
WSGI_APPLICATION = 'FlowControl.wsgi.application'
